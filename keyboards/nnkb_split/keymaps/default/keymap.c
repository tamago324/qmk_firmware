...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LSFT_T(KC_Z),   LGUI_T(KC_X),    KC_C, ALT_T(KC_V), KC_B,    KC_N, KC_M,  KC_COMM, KC_DOT,  ALT_T(KC_Q),
                      L1 ,LOWER,  LCTL_T(KC_SPACE),          SFT_T(KC_ENT), RAISE, SPECIAL
  ),
  [_LOWER] = LAYOUT(
  ...
  [_L1] = LAYOUT(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, JP_GRV, JP_GRV, KC_DELETE,
    KC_LCTRL, ALT_SHIFT_TAB, ALT_TAB, XXXXXXX, XXXXXXX,    KC_LEFT,  KC_DOWN,  KC_UP,   KC_RGHT, KC_END,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_HOME,  KC_PGDN,  KC_PGUP, XXXXXXX,  XXXXXXX,
                      XXXXXXX ,XXXXXXX, XXXXXXX,         KC_LSFT, XXXXXXX, XXXXXXX
  ),
};
