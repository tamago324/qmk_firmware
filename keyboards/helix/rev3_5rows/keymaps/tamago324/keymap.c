...
#define KC_F_L2 LT(_LOWER2, KC_F)
...
const uint16_t PROGMEM comb_keys_Escape2[] = {KC_F, KC_E, COMBO_END}; 
...
// A + Lower + K で 
/* const uint16_t PROGMEM comb_keys_Escape2[] = {LCTL_T(KC_A), LOWER, JP_LBRC, COMBO_END}; */

combo_t key_combos[COMBO_COUNT] = {
  [CMB_ESCAPE] = COMBO(comb_keys_Escape, KC_ESC),
  [CMB_ESCAPE2] = COMBO(comb_keys_Escape2, KC_ESC),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
         ...
         XXXXXXX, KC_TAB,    KC_W,    KC_E,    KC_R,    KC_T,                                                           KC_Y,    KC_U,    KC_I,    KC_O,    KC_BSPC,    XXXXXXX, \
         XXXXXXX, KC_A,    KC_S,    KC_D,    KC_F, KC_G,                                                           KC_H,    KC_J,    KC_K,    KC_L,    KC_P, XXXXXXX, \
XXXXXXX, LSFT_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,                     XXXXXXX, XXXXXXX,                     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_Q, XXXXXXX, \
         XXXXXXX, XXXXXXX, XXXXXXX, TD(TD_ALT_GUI),    LOWER,   LCTL_T(KC_SPACE),          XXXXXXX, XXXXXXX,           SFT_T(KC_ENT),     RAISE,   LALT_T(KC_SLSH), XXXXXXX, XXXXXXX, XXXXXXX \
  ),
  [_LOWER] = LAYOUT( \
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
      XXXXXXX, KC_EXLM, JP_AT,   KC_HASH, KC_DLR,  KC_PERC,                                                         JP_CIRC, JP_AMPR, JP_ASTR, JP_LPRN, JP_RPRN, XXXXXXX, \
      XXXXXXX, KC_LCTRL, XXXXXXX, S(KC_COMM), S(KC_DOT), JP_TILD,                                                        JP_MINS, JP_EQL,  JP_LBRC, JP_RBRC, JP_COLN, XXXXXXX, \
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, JP_BSLS, JP_PIPE,                     XXXXXXX, XXXXXXX,                  JP_UNDS, JP_PLUS, JP_LCBR, JP_RCBR, S(KC_SLSH), XXXXXXX, \
      XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______,                     XXXXXXX, XXXXXXX,                  KC_LCTRL, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX \
      ),
  [_RAISE] = LAYOUT( \
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, \
      XXXXXXX, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                                           KC_6,     KC_7,     KC_8,    KC_9,    KC_0,    XXXXXXX, \
      XXXXXXX, _______, JU_QUOT, JU_QUOT, JU_QUOT, JP_GRV,                                                         KC_LEFT,  KC_DOWN,  KC_UP,   KC_RGHT, JP_COLN, XXXXXXX,\
      XXXXXXX, _______, XXXXXXX, XXXXXXX, KC_SLSH, KC_SLSH,                     XXXXXXX, XXXXXXX,                  KC_HOME,  KC_PGUP,  KC_PGDN, KC_END,  KC_SLSH, XXXXXXX,  \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      XXXXXXX, KC_F11, JP_DQUO,   JP_DQUO, JP_DQUO, JP_GRV,                                                         C(KC_PGUP), XXXXXXX, XXXXXXX, C(KC_PGDN), KC_F12, XXXXXXX,\
      XXXXXXX, RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX,                     XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, \
      XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______,                     XXXXXXX, XXXXXXX,                     _______, _______, RESET, XXXXXXX, XXXXXXX, XXXXXXX \
      )
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    // 左手の F レイヤーはいらないから、スルーする
    // https://beta.docs.qmk.fm/using-qmk/software-features/feature_layers#functions-id-functions
    case KC_W:
    case KC_E:
    case KC_R:
    case KC_T:
    ...
    case KC_B:
      if (record->event.pressed) {
        //レイヤーがONになっていたら、F + なんかを送信する
        if (IS_LAYER_ON(_LOWER2)) {
          layer_off(_LOWER2);
          tap_code(KC_F);
          tap_code(keycode);
          // キーを送信しない
