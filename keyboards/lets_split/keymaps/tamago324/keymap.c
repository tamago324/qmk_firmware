...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
      ...
      MO(_SPECIAL), _______, KC_LGUI, KC_LALT, LOWER, SFT_T(KC_SPACE),   KC_LSHIFT,  RAISE, KC_RALT, _______, _______, _______ \
    ),
    [_LOWER] = LAYOUT(
      KC_ESC,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,       KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL, \
      _______, C(KC_A), C(KC_S), C(KC_D), C(KC_F), C(KC_G),       KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD, \
      _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), C(KC_B),       KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV, \
      _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______ \
    ),
    [_RAISE] = LAYOUT(
      _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,          KC_6,     KC_7,     KC_8,     KC_9,    KC_0,    XXXXXXX, \
      _______, XXXXXXX, KC_QUOT, KC_QUOT, KC_QUOT, XXXXXXX,        KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT, XXXXXXX,  XXXXXXX, \
      _______, XXXXXXX, XXXXXXX, KC_COMM,  KC_DOT, XXXXXXX,       KC_HOME,  KC_PGUP,  KC_PGDN,  KC_END,  XXXXXXX, XXXXXXX, \
      _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______ \
    ),
    [_ADJUST] = LAYOUT(
      KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,         KC_F6,    KC_F7,    KC_F8,    KC_F9,   KC_F10,   KC_F12, \
      _______, XXXXXXX, XXXXXXX, S(KC_QUOT), S(KC_QUOT), XXXXXXX, C(KC_PGUP),  XXXXXXX,  XXXXXXX,  C(KC_PGDN), XXXXXXX,  XXXXXXX, \
