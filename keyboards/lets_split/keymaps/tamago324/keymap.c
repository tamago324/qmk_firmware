...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
      ...
      MO(_SPECIAL), _______, KC_LGUI, KC_LALT, LOWER, KC_SPACE,   KC_LSHIFT,  RAISE, KC_RALT, _______, _______, _______ \
    ),
    [_LOWER] = LAYOUT(
    ...
    [_RAISE] = LAYOUT(
      ...
      _______, KC_QUOT, XXXXXXX, XXXXXXX, S(KC_QUOT), XXXXXXX,    KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT, XXXXXXX,  XXXXXXX, \
