...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LSFT_T(KC_Z),   KC_X,    KC_C, ALT_T(KC_V), KC_B,    KC_N, KC_M,  KC_COMM, KC_DOT,  ALT_T(KC_Q),
                      MO(_MOUSE), LOWER,  LCTL_T(KC_SPACE),          SFT_T(KC_ENT), RAISE, SPECIAL
  ),
  [_LOWER] = LAYOUT(
      ...
      OSL(_WIN), XXXXXXX, ALT_S_TAB, ALT_TAB,  JP_CIRC,   JP_UNDS, JP_EQL, JP_LCBR, JP_RCBR, XXXXXXX,
  ...
  [_MOUSE] = LAYOUT(
    ...
    XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_BTN4, XXXXXXX, XXXXXXX, KC_BTN5, XXXXXXX,
