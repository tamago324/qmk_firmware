...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LSFT_T(KC_Z),   KC_X,    KC_C, ALT_T(KC_V), KC_B,    KC_N, ALT_T(KC_M),  KC_COMM, KC_DOT,  KC_Q,
                      SPECIAL ,LOWER,  LCTL_T(KC_SPACE),          SFT_T(KC_ENT), RAISE, SPECIAL
  ),
  [_LOWER] = LAYOUT(
  ...
  [_SPECIAL] = LAYOUT(
    ...
    XXXXXXX, KC_F1, KC_F2, KC_F3, KC_F11,              LALT(KC_LEFT), XXXXXXX, XXXXXXX, LALT(KC_RGHT),XXXXXXX,
